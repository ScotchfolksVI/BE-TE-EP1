...
namespace IdeaCenterExamPrep
{
    ...
    private const string StaticToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..5Xg75iOZDE6jccjJBGPT761LBICbcbF2_gQid8vcvgQ";
    private const string LoginEmail = "vili1@vili1.com";
    private const string LoginPassword = "vili1vili1";
        ...
        private string GetJwtToken(string email, string password)
        {
            ...
            if(response.StatusCode == HttpStatusCode.OK)
            {
                ...
                {
                    throw new InvalidOperationException("Failed to retrieve JWT token from response.");
        ...
        public void DeletedIdea_ShouldReturnSuccess()
        {
        ...
        public void CreateIdea_WithoutRequeiredFields_ShouldReturnBadRequest()
        {
            var ideaRequest = new IdeaDTO
            {
                Title = "",
